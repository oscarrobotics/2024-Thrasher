...
public class RobotContainer {
   ...
   ShootCmd = new SequentialCommandGroup(
       ...
       new RunCommand( () -> m_shooter.shootNote()).withTimeout(0.1),
        new WaitCommand(0.5),
        new RunCommand( () ->m_sled.runSled()).withTimeout(0.1),
        new WaitCommand(1),
        new ParallelCommandGroup(
        new RunCommand(() -> m_shooter.stop()).withTimeout(0.05),
         new RunCommand(() -> m_sled.stop()).withTimeout(0.05))
